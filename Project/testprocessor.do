...
mem load -filltype value -filldata {1100100100100000 } -fillradix binary /processor/fetchStagee/instructions/ram(1)
mem load -filltype value -filldata {1100100010010000 } -fillradix binary /processor/fetchStagee/instructions/ram(2)
...
mem load -filltype value -filldata {1111000010101100 } -fillradix binary /processor/fetchStagee/instructions/ram(5)
run
run
run
run
