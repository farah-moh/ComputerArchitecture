...
mem load -filltype value -filldata {1100100010010010 } -fillradix binary /processor/fetchStagee/instructions/ram(3)
mem load -filltype value -filldata {1100100010010010 } -fillradix binary /processor/fetchStagee/instructions/ram(4)
mem load -filltype value -filldata {1100100010010010 } -fillradix binary /processor/fetchStagee/instructions/ram(5)
mem load -filltype value -filldata {1100100010010010 } -fillradix binary /processor/fetchStagee/instructions/ram(6)
mem load -filltype value -filldata {1100100010010010 } -fillradix binary /processor/fetchStagee/instructions/ram(7)
